...
(function () {
  ...
  const DAILY_ROUTINE = [
    ...
    { start: "05:00AM", end: "07:00AM", activity: "ECSE643L - L1 Capstone" },
    { start: "07:00AM", end: "09:00AM", activity: "Workout -> Skin Care & Shower -> Breakfast" },
    { start: "09:00AM", end: "11:00AM", activity: "ECSE643L - L1 Capstone" },
    ...
    { start: "07:00PM", end: "09:00PM", activity: "CRW-II -> ECSE643L - L1 Capstone" },
  ...
  function deriveTrack(activity, categoryKey) {
    ...
    const has643 = /ecse643/.test(text);
    const has848 = /ecse848/.test(text);

    if (has643 && has848) return "Dual-capstone focus block";
    if (has643) return "L1 Capstone";
  ...
  function renderMetrics(insights) {
    return [
      ...
      { label: "Deep work", value: formatDuration(insights.totals.focus), note: "L1 Capstone and CRW-II." },
